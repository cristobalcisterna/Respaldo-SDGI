    ...
    >
       ...
       <div
        ...
        >
          ...
          class="has-text-right"
          style="margin-top: 60px; margin-left: 3px; margin-right: 3px"
          :hidden="good.activegood == 1"
        >
          <b-button
            label="Restaurar Bien"
            type="is-danger"
            icon-left="trash-arrow-up"
            :disabled="good.activegood == 1"
          ...
          />
            ...
            <div class="columns">
              ...
              <div class="column">
                <b-field label="Fuente de Financiamiento: ">
                 ...
                 icon="eye"
                icon-clickable
                @icon-click="Clickfinancial(good.financial_source_id)"
                ...
                <b-field label="Tipo de inversión: ">
                 ...
                 icon="eye"
                icon-clickable
                @icon-click="Clickshowtipe(good.investment_type_id)"
            ...
            <div class="columns">
              ...
              <div class="column">
                ...
                icon="eye"
                icon-clickable
                @icon-click="Clickshowdutymanager(good.duty_manager_id)"
            ...
            <div class="columns">
              <div class="column">
                <b-field label="Unidad: ">
                  ...
                  icon="eye"
                icon-clickable
                @icon-click="Clickshowunit(good.duty_manager.unit_id)"
              ...
              <div class="column">
                <b-field label="Edificio: ">
                  <b-input
                                  icon="eye"
                icon-clickable
                @icon-click="Clickshowbuilding(good.office.building_id)"
              ...
              <div class="column">
                <b-field label="Dependencia: ">
                  <b-input
                                                    icon="eye"
                icon-clickable
                @icon-click="Clickshowoffice(good.office_id)"
...
export default {
  ...
  methods: {
    async getgoods() {
      ...
      console.log(this.auxdatebuy);
      console.log(this.auxdatedesign);
