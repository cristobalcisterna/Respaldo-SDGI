...
document.addEventListener('turbolinks:load', () => {
  ...
  const app = new Vue({
    ...
    components: { App,welcome, FontAwesomeIcon, PageSidebar, IndexInvestmentTypes, ShowInvestmentTypes, NewInvestmentTypes, IndexFinancialSources, ShowFinancialSources, NewFinancialSources, ShowDutyManager, IndexUnit, ShowUnit, NewUnit, IndexDutyManager, IndexBuilding, IndexOffice, IndexGood, ShowBuilding , ShowOffice , ShowGood, NewGood, NewDutyManager, NewBuilding, NewOffice, EditGood, EditConditionGood, IndexConditionGood, ShowConditionGood, NewConditionGood}
  })
})
