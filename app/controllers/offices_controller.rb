class OfficesController < ApplicationController
  ...
  def show_office_building
    @offices = Office.unscoped{Office.where(building_id: params[:id])}
  end
  ...
  private
    ...
    def office_params
      params.require(:office).permit(:name_office, :identification_number_office, :location, :office_description, :hours_available, :square_meter, :campus_identification, :duty_manager_id, :building_id)
    end
end
